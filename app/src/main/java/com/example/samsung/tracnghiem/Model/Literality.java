...
public class Literality extends SQLiteOpenHelper {
    private static final String Database_path = "/data/data/com.example.samsung.tracnghiem/databases/";
    private static final String Database_name = "literality.db";
    private static final String Table_name = "literality";
    ...
    public Literality(Context context) {
