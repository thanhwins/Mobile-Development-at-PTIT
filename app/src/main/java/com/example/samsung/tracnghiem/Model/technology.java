...
public class technology extends SQLiteOpenHelper {

    private static final String Database_path = "/data/data/com.example.samsung.tracnghiem/databases/";
    private static final String Database_name = "technology.db";
    private static final String Table_name = "technology";
    ...
    public technology(Context context) {//constructor
