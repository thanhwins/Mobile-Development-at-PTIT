...
public class Navigation_Activity extends AppCompatActivity
    ...
    public final static String Message = "com.example.samsung.tracnghiem.MESSAGE";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (nav_header_gender.equals("Nam")) {
        ...
        c1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                progressBar.setMessage("Đang tải câu hỏi ...");//Title shown in the progress bar
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_scorecard) {
            ...
            intent.putExtra(Intent.EXTRA_SUBJECT, "Ứng dụng trắc nghiệm");
            ...
            Intent i = new Intent(this, MainActivity.AboutUs.class);
            startActivity(i);
        }
